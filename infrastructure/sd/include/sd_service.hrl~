-define(SERVICE,oam_service).  % Defines the application in app file
-define(SERVICE_SERVER,oam_server). % 
-define(SERVICE_SUP,oam_service_sup).

-define(CALLBACKMODULE,oam_service). % Call back module used by the gen_server
